	...
	wp.customize( 'ff_newsletter_primary_color', function( value ) {
		value.bind( function( newval ) {
			$( '#content .content-txt H1, #content .content-txt H2,' +
			   ...
			   '#content .content-txt H5, #content .content-txt H6,' +
			   '#sidebar .this-issue .featured SPAN' ).css( 'color', newval );
		} );
	} );
	...
	wp.customize( 'ff_newsletter_secondary_color', function( value ) {
		value.bind( function( newval ) {
			$( '.table-banded,' +
				...
				'#sidebar .this-issue .category,' +
				'HR,' +
				'#main .no-thumb-article-table,'+
				'.article-container .article-text.no-img' ).css( 'border-color', newval );
			...
			$( '.table-banded TR:nth-of-type(2n) TD,'+
				'#sidebar .this-issue H3' ).css( 'background-color', hexToRgb(newval, 0.2) );
		} );
	} );
	...
	wp.customize( 'ff_newsletter_link_color', function( value ) {
		value.bind( function( newval ) {
			$( '.home .article-container A.more,'+
			   ...
			   '.home .feature-container A.more,'+
			   '.home .feature-container H3 A,'+
			   '.single-article .content-txt A,'+
			   '#article-prevnext A,'+
			   '#sidebar A,'+
			   '.pullquote P:before,'+
			   '.pullquote P:after' ).css( 'color', newval );
