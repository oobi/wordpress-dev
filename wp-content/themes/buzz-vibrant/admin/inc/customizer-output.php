...
function ff_get_theme_default_css_tokens() {
	...
	$defaults = array(
		'color' => array(
			...
			// theme colors
			'ff_newsletter_header_bgcolor'		=> '600a74',
			'ff_newsletter_header_txtcolor'		=> 'FFFFFF',
			'ff_newsletter_menu_bgcolor'		=> '9540a9',
			'ff_newsletter_menu_txtcolor'		=> 'FFFFFF',
			'ff_newsletter_primary_color' 		=> '600a74',
			'ff_newsletter_secondary_color' 	=> 'fdce25',
			'ff_newsletter_link_color' 			=> '9540a9',
			'ff_social_icon_bgcolor' 			=> 'fdce25',
			'ff_social_icon_txtcolor' 			=> 'FFFFFF',
			'ff_newsletter_widgets_bgcolor'		=> 'eeeeee',
		...
		'string' => array(
			...
			'ff_heading_font'	=> "'Muli', Arial, sans-serif",
