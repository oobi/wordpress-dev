...
if( !empty( $articles['featured'] ) ) :
	foreach( $articles['featured'] as $feature ) : ?>
		...
		<table class="row-container" border="0" cellpadding="0" cellspacing="0" width="640">
			<tr>
				<td>
					<table class="feature-table" border="0" cellpadding="0" cellspacing="0" width="640">
						<tr class="feature">
						...
						<tr class="feature">
							<td class="feature excerpt" valign="top">
