...
class Admin
{
	...
	function __construct()
	{
		...
		add_action('password_protected_login_head', array( $this, 'custom_login_logo' ) ); // support Password Protected plugin
		add_action('admin_init', 				array( $this, 'add_page_excerpt_support' ) );
		add_action('admin_menu', 				array( $this, 'override_comments' ), 999);
	...
	public function modify_admin_footer () {
	 	echo 'Created by <a href="http://www.fireflyinteractive.net">Buzz Interactive</a>. ';
	...
	public function custom_login_logo() {
		...
		if( $site_logo_id ) {
			...
			$logo_url = get_bloginfo('template_directory').'/assets/images/logo.svg';
		}
