...
class Articles {
    ...
    public function get() {
        ...
        $this->articles = Timber::get_posts( $args, 'Firefly\Buzz\Timber\BuzzPost' ); // get as BuzzPosts
	 ...
	 */
	public static function pluck( &$items, $qty=0, $flags=array(), $fill=true ) {
		$result = array();
		$all = false;
