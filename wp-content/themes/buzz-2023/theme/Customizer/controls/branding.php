...
\Kirki::add_field( $this->config_id, array(
	'type'      => 'image',
	'settings'  => "{$section_id}_header_image_xl",
	'label'     => ff__( 'Header Image (XL Screens)' ),
	'description' => ff__( 'Recommended size: <strong>1400px x 120px</strong>' ),
	'section'   => $section_id,
	'choices'   => [
		'save_as' => 'id',
	],
...
\Kirki::add_field( $this->config_id, array(
	...
	'description' => ff__( 'Recommended size: <strong>1200px x 120px</strong>' ),
	'section'   => $section_id,
	'choices'   => [
		'save_as' => 'id',
	],
...
\Kirki::add_field( $this->config_id, array(
	...
	'description' => ff__( 'Recommended size: <strong>768px x 120px</strong>' ),
	'section'   => $section_id,
	'choices'   => [
		'save_as' => 'id',
	],
