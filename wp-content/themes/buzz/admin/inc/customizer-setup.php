...
function ff_customize_register( $wp_customize ) {
	...
	// Widget Area Layout
	$wp_customize->add_section( 'ff_widget_area_layout', array(
		'title' 	=> __('Footer Layout', 'ff_newsletter'),
	...
	$wp_customize->add_control( new FF_Custom_Radio_Image_Control( $wp_customize, 'ff_widget_layout', array(
		...
		'choices'        => array(
			'col-12'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/12.png" alt="' . __( '1 Column', 'ff_newsletter' ) . '" title="' . __( '1 Column', 'ff_newsletter' ) . '">',
			'col-6-6'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/6-6.png" alt="' . __( '2 Columns - Even width', 'ff_newsletter' ) . '" title="' . __( '2 Columns - Even width', 'ff_newsletter' ) . '">',
			'col-9-3'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/9-3.png" alt="' . __( '2 Columns - Large Left', 'ff_newsletter' ) . '" title="' . __( '2 Columns - Large Left', 'ff_newsletter' ) . '">',
			'col-3-9'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/3-9.png" alt="' . __( '2 Columns - Large Right', 'ff_newsletter' ) . '" title="' . __( '2 Columns - Large Right', 'ff_newsletter' ) . '">',
			'col-6-3-3'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/6-3-3.png" alt="' . __( '3 Columns - Large Left', 'ff_newsletter' ) . '" title="' . __( '3 Columns - Large Left', 'ff_newsletter' ) . '">',
			'col-3-3-6'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/3-3-6.png" alt="' . __( '3 Columns - Large Right', 'ff_newsletter' ) . '" title="' . __( '3 Columns - Large Right', 'ff_newsletter' ) . '">',
			'col-3-6-3'		=> '<img src="' . get_template_directory_uri() . '/images/widgets/3-6-3.png" alt="' . __( '3 Columns - Large Middle', 'ff_newsletter' ) . '" title="' . __( '3 Columns - Large Middle', 'ff_newsletter' ) . '">',
			'col-3-3-3-3'	=> '<img src="' . get_template_directory_uri() . '/images/widgets/3-3-3-3.png" alt="' . __( '4 Columns', 'ff_newsletter' ) . '" title="' . __( '4 Columns', 'ff_newsletter' ) . '">'
		)
	) ) );
	...
	// date format
	$today = time();
	$wp_customize->add_setting( 'ff_date_format', array(
		'default' 	=> TRUE
	) );
