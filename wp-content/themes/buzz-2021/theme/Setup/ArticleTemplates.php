 ...
 * (eg. An article template with slug "template-one" should have a twig named "template-one.html.twig")
 */
    ...
    function __construct() {
		...
		*/
		...
		$this->templates['email_featured'] = [
			...
			[
				'slug'		=> 'image-left-retina',
				'name'		=> 'Image left 2x Images',
				'max'		=> -1,
				'alt'		=> 'image-right-retina', // TODO: support alternate rows (use a different twig every x articles)
			],
			[
				'slug'		=> 'image-right-retina',
				'name'		=> 'Image right 2x Images',
				'max'		=> -1,
				'alt'		=> 'image-left-retina',
			],
			[
				'slug'		=> 'image-above',
				'name'		=> 'Image above',
			...
			[
				'slug'		=> 'image-above-readmore',
				'name'		=> 'Image above readmore',
				'max'		=> -1,
				'alt'		=> false,
			],
			// [
