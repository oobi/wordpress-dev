...
\Kirki::add_field( $this->config_id, array(
	...
	'description' 	=> ff__( 'This field uses <a href="http://php.net/manual/en/function.strftime.php" target="_blank">PHP "strftime" format strings and limited html. E.g. %e %B</a>' ),
	'section'   	=> $section_id,
	'default'		=> '',
...
// show article list as dropdown menu
\Kirki::add_field( $this->config_id, array(
	'type'      => 'toggle',
	'settings'  => "{$section_id}_articles",
	'label'     => ff__( 'Show article list' ),
	'section'   => $section_id,
	'default'	=> true
) );