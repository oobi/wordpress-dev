...
$wizard = new Merlin(
	...
	$config = array(
		...
		'dev_mode'             => defined('WP_DEBUG') && WP_DEBUG,  // Enable development mode for testing.
	...
	$strings = array(
		...
		'ready-link-2'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://support.fi.net.au', esc_html__( 'Get Theme Support', '@@textdomain' ) ),
