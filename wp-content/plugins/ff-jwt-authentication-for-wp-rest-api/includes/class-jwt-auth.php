...
class Jwt_Auth
{
    ...
    private function load_dependencies()
    {
         ...
         * Load JWT lib
         */
        require_once plugin_dir_path(dirname(__FILE__)).'includes/php-jwt/BeforeValidException.php';
        require_once plugin_dir_path(dirname(__FILE__)).'includes/php-jwt/ExpiredException.php';
        require_once plugin_dir_path(dirname(__FILE__)).'includes/php-jwt/SignatureInvalidException.php';
        require_once plugin_dir_path(dirname(__FILE__)).'includes/php-jwt/JWT.php';
