=== Firefly - JWT Authentication for WP REST API ===

Contributors: tmeister, firefly
...
*Modified by Firefly to change namespace of Firebase/JWT dependency, which conflicts with Google auth libraries*

Otherwise this is the same as the v1.2.3 of the original plugin.
...
== Changelog ==
= 1.3.5 =
* Firefly: Added default token expiry

= 1.3.4 =
* Firefly: Bug fix - even more missing namespaces

= 1.3.3 =
* Firefly: Bug fix - even more missing namespaces

= 1.3.2 =
* Firefly: Bug fix - more missing namespaces

= 1.3.1 =
* Firefly: Bug fix - missing namespaces

= 1.3 =
* Firefly: remove Composer dependencies and namespace Firebase/JWT library to prevent conflict with Google auth libraries.
