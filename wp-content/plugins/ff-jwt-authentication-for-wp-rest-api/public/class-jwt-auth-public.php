...
class Jwt_Auth_Public
{
    ...
    public function __construct($plugin_name, $version)
    {
		...
		$this->jwt_auth_expire_default  = defined('JWT_AUTH_EXPIRE') ? JWT_AUTH_EXPIRE : (DAY_IN_SECONDS * 7);
    }
    ...
    public function generate_token($request)
    {
        ...
        $expire = apply_filters('jwt_auth_expire', $issuedAt + $this->jwt_auth_expire_default, $issuedAt);
