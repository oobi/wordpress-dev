 ...
 * @subpackage Midgard_Twitter/includes
 * @author     Firefly Interactive <info@fi.net.au>
 */
class Midgard_Twitter extends Midgard_Plugin_Base {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Midgard_Twitter_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct($plugin_name, $version) {
		...
		// plugin type strings
		$this->feed_type_label = __('Twitter', 'midgard-twitter');
	 ...
	 *
	 * - Midgard_Twitter_Loader. Orchestrates the hooks of the plugin.
	 * - Midgard_Twitter_i18n. Defines internationalization functionality.
	 * - Midgard_Twitter_Admin. Defines all hooks for the admin area.
	 * - Midgard_Twitter_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once $this->plugin_base . 'plugins/plugin-twitter-ui.php';

		/* Twitter OAuth API */
		require_once $this->plugin_base . 'third-party/twitter-oauth.php';

		/**
		 * The class responsible for retrieving and handling the remote data
		 */
		require_once $this->plugin_base . 'plugins/plugin-twitter-data.php';
	...
	private function define_admin_hooks() {
		...
		// UI handler
		$customise_ui = new Midgard_Twitter_UI($this->feed_type, $this->feed_type_label);
