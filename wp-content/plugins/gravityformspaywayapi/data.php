<?php
class GFPayWayApiData{

    public static function update_table(){
        global $wpdb;
        $table_name = self::get_paywayapi_table_name();
    ...
    public static function get_paywayapi_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_paywayapi";
    }

    public static function get_transaction_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_paywayapi_transaction";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_paywayapi_table_name());
    }
