 ...
 * @since      1.0.0
 * @package    Midgard_XML
 * @subpackage Midgard_XML/includes
 * @author     Firefly Interactive <info@fi.net.au>
 */
class Midgard_XML extends Midgard_Plugin_Base {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Midgard_XML_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct($plugin_name, $version) {
		...
		// plugin type strings
		$this->feed_type_label = __('XML', 'midgard-xml');
		$this->feed_type = 'xml';
	 ...
	 *
	 * - Midgard_XML_Loader. Orchestrates the hooks of the plugin.
	 * - Midgard_XML_i18n. Defines internationalization functionality.
	 * - Midgard_XML_Admin. Defines all hooks for the admin area.
	 * - Midgard_XML_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once $this->plugin_base . 'plugins/plugin-xml-data.php';

		/**
		 * The class responsible for customising the admin area UI
		 */
		require_once $this->plugin_base . 'plugins/plugin-xml-ui.php';
	...
	private function define_admin_hooks() {
		...
		// UI handler
		$customise_ui = new Midgard_XML_UI($this->feed_type, $this->feed_type_label);
