 ...
 * @since      1.0.0
 * @package    Midgard_Rss
 * @subpackage Midgard_Rss/includes
 * @author     Firefly Interactive <info@fi.net.au>
 */
class Midgard_RSS extends Midgard_Plugin_Base {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Midgard_Rss_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct($plugin_name, $version) {
		...
		// plugin type strings
		$this->feed_type_label = __('RSS', 'midgard-rss');
		$this->feed_type = 'rss';
	 ...
	 *
	 * - Midgard_Rss_Loader. Orchestrates the hooks of the plugin.
	 * - Midgard_Rss_i18n. Defines internationalization functionality.
	 * - Midgard_Rss_Admin. Defines all hooks for the admin area.
	 * - Midgard_Rss_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once $this->plugin_base . 'plugins/plugin-rss-data.php';

		/**
		 * The class responsible for customising the admin area UI
		 */
		require_once $this->plugin_base . 'plugins/plugin-rss-ui.php';
	...
	private function define_admin_hooks() {
		...
		// UI handler
		$customise_ui = new Midgard_RSS_UI($this->feed_type, $this->feed_type_label);
