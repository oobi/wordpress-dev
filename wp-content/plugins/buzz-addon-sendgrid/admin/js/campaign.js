(function( $ ) {
	...
	function initSendTab($container) {
		var admin_url = "./edit.php?post_type=newsletter&page=buzz-sendgrid&tab=send";
	...
	function initStatsTab($container) {
		var admin_url = "./edit.php?post_type=newsletter&page=buzz-sendgrid&tab=stats";
		$("#campaign-to-send", $container).change(function(){
			var cid = $(this).val();
			window.location = admin_url + "&cid=" + cid;
		});
	...
	function initCurrentTab($container) {
		var admin_url = "./edit.php?post_type=newsletter&page=buzz-sendgrid&tab=current";
