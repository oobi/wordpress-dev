 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Buzz Add-On - Email View
 * Plugin URI:        http://www.thebuzz.net.au/add-ons/#email-view
 * Description:       Adds an Email View to Buzz Newsletter
 * Version:           1.6
...
if( is_plugin_active( 'buzz-newsletter/buzz-newsletter.php' ) ) {
	...
	require_once( plugin_dir_path( __FILE__ ) . 'class-buzz-addon-email-view.php' );

	// Set up constant (for checking in theme)
	define( 'BUZZ_ADDON_EMAIL_VIEW', TRUE );

	/**
	 * Init Buzz_Addon_Email_View Class
	 */
	$buzz_addon = new Buzz_Addon_Email_View();
