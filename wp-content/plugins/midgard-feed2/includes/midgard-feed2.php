 ...
 * @subpackage Midgard_Feed2/includes
 * @author     Firefly Interactive <info@fi.net.au>
 */
class Midgard_Feed2 extends Midgard_Plugin_Base {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Midgard_Feed2_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct($plugin_name, $version) {
		...
		// plugin type strings
		$this->feed_type_label = __('Feed of Feeds', 'midgard-feed2');
		$this->feed_type = 'feed2';
	 ...
	 *
	 * - Midgard_Feed2_Loader. Orchestrates the hooks of the plugin.
	 * - Midgard_Feed2_i18n. Defines internationalization functionality.
	 * - Midgard_Feed2_Admin. Defines all hooks for the admin area.
	 * - Midgard_Feed2_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 */
		require_once $this->plugin_base . 'plugins/plugin-feed2-data.php';

		/**
		 * The class responsible for customising the admin area UI
		 */
		require_once $this->plugin_base . 'plugins/plugin-feed2-ui.php';
	...
	private function define_admin_hooks() {
		...
		// UI handler
		$customise_ui = new Midgard_Feed2_UI($this->feed_type, $this->feed_type_label);
	...
	public function enqueue_scripts() {
		...
		if($screen && $screen->base == 'post' && $screen->post_type == 'data_feed') {
			wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/midgard-feed2.js', array( 'jquery' ), $this->version, false );
		}
